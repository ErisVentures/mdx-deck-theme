...
var colors = {
  ...
  boxA: "rgba(255, 205, 0, 0.5)",
  boxB: "rgba(255, 205, 0, 0.7)",
  boxC: "rgba(255, 205, 0, 1)",
  ui: {
    border: "#ede7f3",
    bright: "#e0d6eb",
    light: "#f5f3f7",
...
var Container$1 = styled__default.div(_templateObject$3(), colors.backgroundAlt, colors.background, 'gray');
...
var theme$1 = _objectSpread({}, theme, {
  font: header.join(','),
  monospace: code.join(','),
